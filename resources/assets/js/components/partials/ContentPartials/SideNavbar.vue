                        ...
                        <ul id="mainnav-menu" class="list-group">
                            ...
                            <li class="active-sub">
                                ...
                                <ul class="collapse in">
                                    ...
                                    <li class="active-link"><a href="layouts-offcanvas-navigation.html">Off-Canvas
                                        Navigation</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="misc-nestable-list.html">Nestable List<span
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="pages-invoice.html">Invoice<span
                                            class="label label-info pull-right">New</span></a></li>
...
<script>
    export default{
        mounted(){
            console.info('SideNavbar.vue is mounted.');
        }
    }
</script>
